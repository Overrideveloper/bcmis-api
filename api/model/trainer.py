...
from sklearn.metrics import confusion_matrix, make_scorer, accuracy_score, auc, roc_curve
...
imagePatches = glob('C:/Users/banso/Desktop/bcmis-api/dataset/input/**/*.png', recursive=True)
for filename in imagePatches[0:10]:
    print(filename)

image_name = "C:/Users/banso/Desktop/bcmis-api/dataset/input/9135/1/9135_idx5_x1701_y1851_class1.png" #Image to be used as query
...
#     img_rows, img_cols = a.shape[1],a.shape[2]
    ...
    history = model.fit_generator(datagen.flow(a,b, batch_size=32),
                        steps_per_epoch=len(a), epochs=epochs,class_weight=f, validation_data = [c, d],callbacks = [MetricsCheckpoint('logs')])
    ...
    fpr, tpr, thresholds = roc_curve(Y_pred_classes, Y_true)
