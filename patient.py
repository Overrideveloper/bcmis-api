...
def addPatient(_name, _age, _height, _weight, _blood_group, _genotype):
    name = _name
    age = _age
    height = _height
    weight = _weight
    ...
    new_patient = Patient(name, age, height, weight, blood_group, genotype)
...
def editPatient(id, name, age, height, weight, blood_group, genotype):
    patient = Patient.query.get(id)
    patient.name = name
    patient.age = age
